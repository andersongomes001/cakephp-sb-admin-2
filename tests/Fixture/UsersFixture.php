...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'users_ibfk_1' => ['type' => 'foreign', 'columns' => ['perfil_id'], 'references' => ['perfil', 'id'], 'update' => 'cascade', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'ativo' => 1,
                'perfil_id' => 1,
                'created' => '2019-03-23 15:09:43',
                'modified' => '2019-03-23 15:09:43'
            ],
        ];
        parent::init();
    }
